...
static PyObject* is_ok(PygtsPoint* self, PyObject* args)
{
...
static PyObject* set(PygtsPoint* self, PyObject* args)
{
	gdouble x = 0, y = 0, z = 0;
...
static PyObject* coords(PygtsPoint* self, PyObject* args)
{
	SELF_CHECK

	return Py_BuildValue("ddd", PYGTS_POINT_AS_GTS_POINT(self)->x, PYGTS_POINT_AS_GTS_POINT(self)->y, PYGTS_POINT_AS_GTS_POINT(self)->z);
}


static PyObject* is_in_rectangle(PygtsPoint* self, PyObject* args)
{
	PyObject *  o1_, *o2_;
	PygtsPoint *p1, *p2;
	gboolean    flag = FALSE;
	...
	if (PYGTS_POINT_AS_GTS_POINT(p1)->x == x || PYGTS_POINT_AS_GTS_POINT(p1)->y == y || PYGTS_POINT_AS_GTS_POINT(p2)->x == x
	    || PYGTS_POINT_AS_GTS_POINT(p2)->y == y) {
		flag = TRUE;
	}

	if (gts_point_is_in_rectangle(PYGTS_POINT_AS_GTS_POINT(self), PYGTS_POINT_AS_GTS_POINT(p1), PYGTS_POINT_AS_GTS_POINT(p2))) {
		if (flag) {
		...
		if (flag && gts_point_is_in_rectangle(PYGTS_POINT_AS_GTS_POINT(self), PYGTS_POINT_AS_GTS_POINT(p2), PYGTS_POINT_AS_GTS_POINT(p1))) {
			return Py_BuildValue("i", 0);
		} else {
			return Py_BuildValue("i", -1);
		}
...
static PyObject* distance(PygtsPoint* self, PyObject* args)
{
	PyObject*      o_;
	PygtsPoint*    p = NULL;
	PygtsSegment*  s = NULL;
	...
	if (pygts_point_check(o_)) {
		...
		if (pygts_segment_check(o_)) {
			...
			if (pygts_triangle_check(o_)) {
				...
				PyErr_SetString(PyExc_TypeError, "expected a Point, Segment or Triangle");
				return NULL;
			}
		}
	}
	...
	if (p != NULL) {
		return Py_BuildValue("d", gts_point_distance(PYGTS_POINT_AS_GTS_POINT(self), PYGTS_POINT_AS_GTS_POINT(p)));
	} else {
		if (s != NULL) {
			return Py_BuildValue("d", gts_point_segment_distance(PYGTS_POINT_AS_GTS_POINT(self), PYGTS_SEGMENT_AS_GTS_SEGMENT(s)));
		} else {
			return Py_BuildValue("d", gts_point_triangle_distance(PYGTS_POINT_AS_GTS_POINT(self), PYGTS_TRIANGLE_AS_GTS_TRIANGLE(t)));
		}
	}
}


static PyObject* distance2(PygtsPoint* self, PyObject* args)
{
	PyObject*      o_;
	PygtsPoint*    p = NULL;
	PygtsSegment*  s = NULL;
	...
	if (p != NULL) {
		return Py_BuildValue("d", gts_point_distance2(PYGTS_POINT_AS_GTS_POINT(self), PYGTS_POINT_AS_GTS_POINT(p)));
	} else {
		if (s != NULL) {
			return Py_BuildValue("d", gts_point_segment_distance2(PYGTS_POINT_AS_GTS_POINT(self), PYGTS_SEGMENT_AS_GTS_SEGMENT(s)));
		} else {
			return Py_BuildValue("d", gts_point_triangle_distance2(PYGTS_POINT_AS_GTS_POINT(self), PYGTS_TRIANGLE_AS_GTS_TRIANGLE(t)));
		}
	}
}


static PyObject* orientation_3d(PygtsPoint* self, PyObject* args)
{
	...
	return Py_BuildValue(
	        ...
	        gts_point_orientation_3d(
	                PYGTS_POINT_AS_GTS_POINT(p1), PYGTS_POINT_AS_GTS_POINT(p2), PYGTS_POINT_AS_GTS_POINT(p3), PYGTS_POINT_AS_GTS_POINT(self)));
}


static PyObject* orientation_3d_sos(PygtsPoint* self, PyObject* args)
{
	PyObject *  p1_, *p2_, *p3_;
	PygtsPoint *p1, *p2, *p3;
...
static PyObject* is_in_circle(PygtsPoint* self, PyObject* args)
{
	...
	if (t != NULL) {
		result = gts_point_in_triangle_circle(PYGTS_POINT_AS_GTS_POINT(self), PYGTS_TRIANGLE_AS_GTS_TRIANGLE(t));
	} else {
...
static PyObject* is_in(PygtsPoint* self, PyObject* args)
{
	PyObject*      t_;
	PygtsTriangle* t;
	...
	return Py_BuildValue("i", gts_point_is_in_triangle(PYGTS_POINT_AS_GTS_POINT(self), PYGTS_TRIANGLE_AS_GTS_TRIANGLE(t)));
}


static PyObject* is_inside(PygtsPoint* self, PyObject* args)
{
	PyObject*     s_;
	PygtsSurface* s;
	GNode*        tree;
   ...
   */
	...
	/* Make the call */
	ret = gts_point_is_inside_surface(PYGTS_POINT_AS_GTS_POINT(self), tree, is_open);
...
static PyObject* closest(PygtsPoint* self, PyObject* args)
{
	PyObject *     o1_, *o2_;
	PygtsPoint*    p = NULL;
	PygtsSegment*  s = NULL;
	...
	if (pygts_segment_check(o1_)) {
		...
		if (pygts_triangle_check(o1_)) {
			...
			PyErr_SetString(PyExc_TypeError, "expected a Segment or Triangle, and a Point");
			return NULL;
		}
	}
	if (pygts_point_check(o2_)) {
	...
	if (s != NULL) {
		gts_point_segment_closest(PYGTS_POINT_AS_GTS_POINT(p), PYGTS_SEGMENT_AS_GTS_SEGMENT(s), PYGTS_POINT_AS_GTS_POINT(self));
	} else {
		gts_point_triangle_closest(PYGTS_POINT_AS_GTS_POINT(p), PYGTS_TRIANGLE_AS_GTS_TRIANGLE(t), PYGTS_POINT_AS_GTS_POINT(self));
	}
...
static PyObject* rotate(PygtsPoint* self, PyObject* args, PyObject* keywds)
{
...
static PyObject* scale(PygtsPoint* self, PyObject* args, PyObject* keywds)
{
...
static PyObject* translate(PygtsPoint* self, PyObject* args, PyObject* keywds)
{
	static char* kwlist[] = { "dx", "dy", "dz", NULL };
...
static PyMethodDef methods[] = {
	...
	{ "orientation_3d_sos",
	  (PyCFunction)orientation_3d_sos,
	  METH_VARARGS,
	  "Determines if this Point p is above, below or on plane of 3 Points\n"
	  "p1, p2 and p3.\n"
	  "\n"
...
static PyObject* getx(PygtsPoint* self, void* closure)
{
	SELF_CHECK
...
static int setx(PygtsPoint* self, PyObject* value, void* closure)
{
...
static PyObject* gety(PygtsPoint* self, void* closure)
{
	SELF_CHECK
...
static int sety(PygtsPoint* self, PyObject* value, void* closure)
{
	if (PyFloat_Check(value)) {
...
static PyObject* getz(PygtsPoint* self, void* closure)
{
	SELF_CHECK
...
static int setz(PygtsPoint* self, PyObject* value, void* closure)
{
	if (PyFloat_Check(value)) {
...
static int init(PygtsPoint* self, PyObject* args, PyObject* kwds)
{
	PygtsObject* obj;
	gdouble      x = 0, y = 0, z = 0;
	guint        a;
...
static int compare(PyObject* p1_, PyObject* p2_)
{
	GtsPoint *p1, *p2;
...
PyTypeObject PygtsPointType = {
	PyVarObject_HEAD_INIT(NULL, 0) "gts.Point", /* tp_name */
...
gboolean pygts_point_is_ok(PygtsPoint* p) { return pygts_object_is_ok(PYGTS_OBJECT(p)); }


PygtsPoint* pygts_point_new(GtsPoint* p)
{
	PyObject *   args, *kwds;
	PygtsObject* point;

	/* Check for Point in the object table */
	if ((point = PYGTS_OBJECT(g_hash_table_lookup(obj_table, GTS_OBJECT(p)))) != NULL) {
		Py_INCREF(point);
...
PygtsPoint* pygts_point_from_sequence(PyObject* tuple)
{
	...
	if ((N = PyTuple_Size(tuple)) > 3) {
		PyErr_SetString(PyExc_RuntimeError, "expected a list or tuple of up to three floats");
		Py_DECREF(tuple);
		return NULL;
	}
