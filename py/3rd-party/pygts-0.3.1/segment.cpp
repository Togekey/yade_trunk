...
static PyObject* is_ok(PygtsSegment* self, PyObject* args)
{
...
static PyObject* intersects(PygtsSegment* self, PyObject* args)
{
	PyObject*   s_;
	GtsSegment* s;
	...
	return Py_BuildValue("i", gts_segments_are_intersecting(PYGTS_SEGMENT_AS_GTS_SEGMENT(self), s));
}


static PyObject* connects(PygtsSegment* self, PyObject* args)
{
	PyObject * v1_, *v2_;
	GtsVertex *v1, *v2;
...
static PyObject* touches(PygtsSegment* self, PyObject* args)
{
	PyObject*   s_;
	GtsSegment* s;
...
static PyObject* midvertex(PygtsSegment* self, PyObject* args)
{
	PygtsVertex* vertex;
	GtsVertex*   v;
...
static PyObject* intersection(PygtsSegment* self, PyObject* args)
{
	...
	v = GTS_VERTEX(gts_segment_triangle_intersection(
	        PYGTS_SEGMENT_AS_GTS_SEGMENT(self), PYGTS_TRIANGLE_AS_GTS_TRIANGLE(t), boundary, GTS_POINT_CLASS(gts_vertex_class())));
...
static PyObject* get_v1(PygtsSegment* self, void* closure)
{
	PygtsObject* v1;
...
static PyObject* get_v2(PygtsSegment* self, void* closure)
{
	PygtsObject* v2;
...
static PyGetSetDef getset[] = {
	{ "v1", (getter)get_v1, NULL, "Vertex 1", NULL }, { "v2", (getter)get_v2, NULL, "Vertex 2", NULL }, { NULL } /* Sentinel */
};
...
static PyObject* new_(PyTypeObject* type, PyObject* args, PyObject* kwds)
{
	...
	if (alloc_gtsobj) {
		...
		segment = GTS_OBJECT(gts_segment_new(gts_segment_class(), GTS_VERTEX(v1->gtsobj), GTS_VERTEX(v2->gtsobj)));
		if (segment == NULL) {
...
static int init(PygtsSegment* self, PyObject* args, PyObject* kwds)
{
	gint ret;
...
static int compare(PyObject* s1_, PyObject* s2_)
{
	GtsSegment *s1, *s2;
...
PyTypeObject PygtsSegmentType = {
	PyVarObject_HEAD_INIT(NULL, 0) "gts.Segment", /* tp_name */
...
PygtsSegment* pygts_segment_new(GtsSegment* s)
{
	PyObject *   args, *kwds;
	PygtsObject* segment;

	/* Check for Segment in the object table */
	if ((segment = PYGTS_OBJECT(g_hash_table_lookup(obj_table, GTS_OBJECT(s)))) != NULL) {
		Py_INCREF(segment);
...
{
	if ((pygts_point_compare(GTS_POINT(s1->v1), GTS_POINT(s2->v1)) == 0 && pygts_point_compare(GTS_POINT(s1->v2), GTS_POINT(s2->v2)) == 0)
	    || (pygts_point_compare(GTS_POINT(s1->v1), GTS_POINT(s2->v2)) == 0 && pygts_point_compare(GTS_POINT(s1->v2), GTS_POINT(s2->v1)) == 0)) {
		return 0;
	}
	return -1;
}
