...
static PyObject* is_ok(PygtsTriangle* self, PyObject* args)
{
...
static PyObject* area(PygtsTriangle* self, PyObject* args)
{
	SELF_CHECK

	return Py_BuildValue("d", gts_triangle_area(PYGTS_TRIANGLE_AS_GTS_TRIANGLE(self)));
}


static PyObject* perimeter(PygtsTriangle* self, PyObject* args)
{
	SELF_CHECK

	return Py_BuildValue("d", gts_triangle_perimeter(PYGTS_TRIANGLE_AS_GTS_TRIANGLE(self)));
}


static PyObject* quality(PygtsTriangle* self, PyObject* args)
{
	SELF_CHECK

	return Py_BuildValue("d", gts_triangle_quality(PYGTS_TRIANGLE_AS_GTS_TRIANGLE(self)));
}


static PyObject* normal(PygtsTriangle* self, PyObject* args)
{
	gdouble x, y, z;
...
static PyObject* revert(PygtsTriangle* self, PyObject* args)
{
	SELF_CHECK
...
static PyObject* orientation(PygtsTriangle* self, PyObject* args)
{
	SELF_CHECK

	return Py_BuildValue("d", gts_triangle_orientation(PYGTS_TRIANGLE_AS_GTS_TRIANGLE(self)));
}


static PyObject* angle(PygtsTriangle* self, PyObject* args)
{
	PyObject*      t_;
	PygtsTriangle* t;
	...
	return Py_BuildValue("d", gts_triangles_angle(PYGTS_TRIANGLE_AS_GTS_TRIANGLE(self), PYGTS_TRIANGLE_AS_GTS_TRIANGLE(t)));
}


static PyObject* is_compatible(PygtsTriangle* self, PyObject* args)
{
	PyObject*      t2_;
	PygtsTriangle* t2;
	GtsEdge*       e;
	...
	/* Get the common edge */
	if ((e = gts_triangles_common_edge(PYGTS_TRIANGLE_AS_GTS_TRIANGLE(self), PYGTS_TRIANGLE_AS_GTS_TRIANGLE(t2))) == NULL) {
		PyErr_SetString(PyExc_RuntimeError, "Triangles do not share common edge");
		return NULL;
	}

	if (gts_triangles_are_compatible(PYGTS_TRIANGLE_AS_GTS_TRIANGLE(self), PYGTS_TRIANGLE_AS_GTS_TRIANGLE(t2), e)) {
		Py_INCREF(Py_True);
		return Py_True;
	} else {
		Py_INCREF(Py_False);
...
static PyObject* common_edge(PygtsTriangle* self, PyObject* args)
{
	PyObject*      t2_;
	PygtsTriangle* t2;
	GtsEdge*       e;
...
static PyObject* vertices(PygtsTriangle* self, PyObject* args)
{
...
static PyObject* vertex(PygtsTriangle* self, PyObject* args)
{
	GtsVertex*   v1_;
	PygtsObject* v1;
...
static PyObject* circumcenter(PygtsTriangle* self, PyObject* args)
{
	PygtsVertex* v;
	GtsVertex*   vertex;
	...
	/* Get the Vertex */
	vertex = GTS_VERTEX(gts_triangle_circumcircle_center(PYGTS_TRIANGLE_AS_GTS_TRIANGLE(self), GTS_POINT_CLASS(gts_vertex_class())));
...
static PyObject* is_stabbed(PygtsTriangle* self, PyObject* args)
{
	PyObject*    p_;
	PygtsVertex* p;
	GtsObject*   obj;
	...
	obj = gts_triangle_is_stabbed(PYGTS_TRIANGLE_AS_GTS_TRIANGLE(self), GTS_POINT(PYGTS_OBJECT(p)->gtsobj), NULL);
...
static PyObject* interpolate_height(PygtsTriangle* self, PyObject* args)
{
	PyObject*   p_;
	PygtsPoint* p;
	GtsPoint    point;
	...
	gts_triangle_interpolate_height(PYGTS_TRIANGLE_AS_GTS_TRIANGLE(self), &point);
...
static PyMethodDef methods[] = {
	...
	{ "interpolate_height",
	  (PyCFunction)interpolate_height,
	  METH_VARARGS,
...
static PyObject* get_e1(PygtsTriangle* self, void* closure)
{
	PygtsEdge* e1;
...
static PyObject* get_e2(PygtsTriangle* self, void* closure)
{
	PygtsEdge* e2;
...
static PyObject* get_e3(PygtsTriangle* self, void* closure)
{
	PygtsEdge* e3;
...
static PyObject* new_(PyTypeObject* type, PyObject* args, PyObject* kwds)
{
	...
	if (alloc_gtsobj) {
		...
		if (!((e1 != NULL && e2 != NULL && e3 != NULL) || (v1 != NULL && v2 != NULL && v3 != NULL))) {
			PyErr_SetString(PyExc_TypeError, "expected three Edges or three Vertices");
			return NULL;
		}
		...
		s2 = GTS_SEGMENT(e2);
		s3 = GTS_SEGMENT(e3);
		if (!((s1->v1 == s3->v2 && s1->v2 == s2->v1 && s2->v2 == s3->v1) || (s1->v1 == s3->v2 && s1->v2 == s2->v2 && s2->v1 == s3->v1)
		      || (s1->v1 == s3->v1 && s1->v2 == s2->v1 && s2->v2 == s3->v2) || (s1->v2 == s3->v2 && s1->v1 == s2->v1 && s2->v2 == s3->v1)
...
static int init(PygtsTriangle* self, PyObject* args, PyObject* kwds)
{
	gint ret;
...
PyTypeObject PygtsTriangleType = {
	PyVarObject_HEAD_INIT(NULL, 0) "gts.Triangle", /* tp_name */
...
PygtsTriangle* pygts_triangle_new(GtsTriangle* t)
{
	...
	if ((triangle = PYGTS_OBJECT(g_hash_table_lookup(obj_table, GTS_OBJECT(t)))) != NULL) {
		Py_INCREF(triangle);
...
{
	if ((pygts_segment_compare(GTS_SEGMENT(t1->e1), GTS_SEGMENT(t2->e1)) == 0 && pygts_segment_compare(GTS_SEGMENT(t1->e2), GTS_SEGMENT(t2->e2)) == 0
	     && pygts_segment_compare(GTS_SEGMENT(t1->e3), GTS_SEGMENT(t2->e3)) == 0)
	    || (pygts_segment_compare(GTS_SEGMENT(t1->e1), GTS_SEGMENT(t2->e3)) == 0 && pygts_segment_compare(GTS_SEGMENT(t1->e2), GTS_SEGMENT(t2->e1)) == 0
	        && pygts_segment_compare(GTS_SEGMENT(t1->e3), GTS_SEGMENT(t2->e2)) == 0)
	    || (pygts_segment_compare(GTS_SEGMENT(t1->e1), GTS_SEGMENT(t2->e2)) == 0 && pygts_segment_compare(GTS_SEGMENT(t1->e2), GTS_SEGMENT(t2->e3)) == 0
	        && pygts_segment_compare(GTS_SEGMENT(t1->e3), GTS_SEGMENT(t2->e1)) == 0)
	    ||

	    (pygts_segment_compare(GTS_SEGMENT(t1->e1), GTS_SEGMENT(t2->e3)) == 0 && pygts_segment_compare(GTS_SEGMENT(t1->e2), GTS_SEGMENT(t2->e2)) == 0
	     && pygts_segment_compare(GTS_SEGMENT(t1->e3), GTS_SEGMENT(t2->e1)) == 0)
	    || (pygts_segment_compare(GTS_SEGMENT(t1->e1), GTS_SEGMENT(t2->e2)) == 0 && pygts_segment_compare(GTS_SEGMENT(t1->e2), GTS_SEGMENT(t2->e1)) == 0
	        && pygts_segment_compare(GTS_SEGMENT(t1->e3), GTS_SEGMENT(t2->e3)) == 0)
	    || (pygts_segment_compare(GTS_SEGMENT(t1->e1), GTS_SEGMENT(t2->e1)) == 0 && pygts_segment_compare(GTS_SEGMENT(t1->e2), GTS_SEGMENT(t2->e3)) == 0
	        && pygts_segment_compare(GTS_SEGMENT(t1->e3), GTS_SEGMENT(t2->e2)) == 0)) {
		return 0;
	}
	return -1;
...
gboolean pygts_gts_triangle_is_ok(GtsTriangle* t)
{
	...
	g_return_val_if_fail(gts_segments_touch(GTS_SEGMENT(t->e1), GTS_SEGMENT(t->e2)), FALSE);
