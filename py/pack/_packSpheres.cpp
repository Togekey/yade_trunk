...
BOOST_PYTHON_MODULE(_packSpheres)
{
	...
	boost::python::class_<SpherePack>(
	        ...
	        .def("makeCloud",
	             ...
	             "``distributeMass==False``), the distribution is applied to particle radii. The usual sense of \"particle size distribution\" is the "
	             "distribution of *mass fraction* (rather than particle count); this can be achieved with ``distributeMass=True``."
	        ...
	        .def("makeClumpCloud",
	             ...
	             "number of attempts to place a new clump randomly is attained.\n\n:param seed: number used to initialize the random number generator.")
	        //
