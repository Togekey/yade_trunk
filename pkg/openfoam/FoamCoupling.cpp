...
void FoamCoupling::insertBodyId(int bId) { bodyList.push_back(bId); }
...
void FoamCoupling::castNumParticle(int value) { MPI_Bcast(&value, 1, MPI_INT, rank, MPI_COMM_WORLD); }
...
void FoamCoupling::resetProcList() { procList.clear(); }
