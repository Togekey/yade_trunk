...
#define DECLARE_TESSELATION_TYPES(baseType)                                                                                                                    \
	...
	public:
		...
		{
			computed = false;
		} //Set the tesselation as "not computed" (computed=false), this will launch tesselation internaly when using functions like computeVolumes())
...
// Alpha Shapes
	...
	template <class Tesselation> class PeriodicTesselation : public Tesselation {
	public:
