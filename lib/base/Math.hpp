...
public:
	...
	Se3() {};
	Se3(Vector3<Scalar> rkP, Quaternion<Scalar> qR)
	{
		position    = rkP;
		orientation = qR;
	}
...
namespace serialization {
	...
	{
		Real &m00 = m(0, 0), &m01 = m(0, 1), &m02 = m(0, 2), &m10 = m(1, 0), &m11 = m(1, 1), &m12 = m(1, 2), &m20 = m(2, 0), &m21 = m(2, 1),
		     &m22 = m(2, 2);
