...
Use drawArrow(const Vec& from, const Vec& to, double radius, int nbSubdivisions) or change the \c
ModelView matrix to place the arrow in 3D.

Uses current color and does not modify the OpenGL state. */
void GLUtils::QGLViewer::drawArrow(double length, double radius, int nbSubdivisions)
{
...
See drawArrow(double length, double radius, int nbSubdivisions) for details. */
