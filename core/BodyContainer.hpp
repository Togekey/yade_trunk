...
public:
	...
	// clang-format off
		...
		((bool,useRedirection,false,,"true if the scene uses up-to-date lists for boundedBodies and realBodies; turned true automatically 1/ after removal of bodies if :yref:`BodyContainer.enableRedirection` =True, and 2/ in MPI execution."))
